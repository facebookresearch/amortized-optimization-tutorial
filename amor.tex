...
\begin{remark}
  ...
  of the parameters, \ie $\hat y_\theta(x)\defeq\theta$, and $p(x)$ to be a Dirac
  centered at a point $\bar x$
\end{remark}
...
This shows a connection between a model trained with gradients of
an objective-based loss and a non-amortized gradient-based solver for
\cref{eq:opt}.
...
% TODO: \citep{sjölund2022graphbased} \citep{bastianello2021opreg}
...
%   Uncertainty-aware learning to optimize \citep{you2022bayesian}
