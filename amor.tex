...
\item \citet{banert2020data} consider theoretical foundations
  ...
  computed tomography. This is further developed in
  \citet{banert2021accelerated}, which has provable convergence
  guarantees when the learned component (\eg, the step size)
...
% TODO: Fast Context Adaptation via Meta-Learning
